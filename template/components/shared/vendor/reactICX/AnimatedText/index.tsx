  ...
  ({
    ...
    return (
      ...
      >
        ...
        {/* Android renders no blur here: expo-blur's Android blur methods need a
            `blurTarget` ref to a BlurTargetView, which a per-character overlay
            cannot reasonably provide. iOS blurs natively. */}
        <AnimatedBlurView
